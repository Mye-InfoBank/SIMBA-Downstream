...
def dgea_server(input, output, session, _adata: reactive.Value[ad.AnnData]):
    ...
    run_dgea_server("run_dgea", _adata, _dds, _design_matrix, _counts, _uniques, _contrast)
    filter_dgea_server("filter_dgea", _dds, _counts, _uniques,
                       _result, _filtered_result, _filtered_genes,
                       _filtered_counts, _reference, _alternative, _contrast, _alpha, _lfc)
    plot_dgea_server("plot_dgea", _filtered_counts, _contrast, _reference, _alternative, _design_matrix,
                     _result, _alpha, _lfc)
